...
const string strMessageMagic = "Razor Signed Message:\n";
...
{
    // Razor: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
        static const int64 BlocksTargetSpacing = 1.25 * 60; // 30 seconds
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Razor: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Razor: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
//  vMerkleTree: 65f705d2f385dc85763a317b3ec000063003d6b039546af5d8195a5ec27ae410 
        ...
        block.nVersion = 1;
        block.nTime    = 1402617600;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1783833;
        ...
        assert(block.hashMerkleRoot == uint256("0x65f705d2f385dc85763a317b3ec000063003d6b039546af5d8195a5ec27ae410"));
...
unsigned char pchMessageStart[4] = { 0xf9, 0xe8, 0xb4, 0xd9 }; // Razor: decrease each by subtracting 2 to bitcoin's value.
